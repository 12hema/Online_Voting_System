...
<body class="bg-dark">
    ...
    <div class="bg-success py-5">
        <h2 class="text-center p-2">Admin Login</h2>
        <div class="container text-center">
            <form action="">
                <div class="mb-3">
                    <input type="text" name="uesrname" class="form-control w-50 m-auto" placeholder="Enter your username" required="required">
                </div>
                <div class="mb-3">
                ...
                <p>User <a href="index.php" class="text-white"> Login Here</a></p>
